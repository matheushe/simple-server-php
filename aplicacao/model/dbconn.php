...
*/
					...
					//-- s� mostra detalhes do erro porque o usu�rio � analista
					
					die('<div style="background:#f00;color:#fff;padding:5px">Desculpe, n�o foi poss�vel conectar ao Banco de Dados <strong>'.strtoupper($db).'</strong>, pode estar temporariamente inoperante. Favor tentar dentro de alguns instantes!'.$msg.'</div>');
				}
